...
module.exports = {
    ...
    execute: async (client, message, args) => {
        ...
        if (!args[0]) {
            return message.channel.send("Silakan Masukkan STEAMID64 yang valid");
        }
        ...
        request(UR_L, function (err, resp, body) {
            ...
            if (KD == -1) {
                return message.channel.send("Tidak valid, pastikan profil Anda tidak pribadi dan Anda telah memasukkan STEAMID64 yang valid!");
            }
            ...
            var embed = new Discord.MessageEmbed()
                ...
                .addField("Didukung oleh:", `**[tracker.gg/csgo](http://tracker.gg/csgo)**`, false)
                .setTimestamp()
                .setColor("0x#FF0000")
...
module.exports.help = {
    name: "csgo",
    description: "Memberikan statistik pemain CSGO",
    usage: "csgo <steamID>",
    type: "Fun"
}